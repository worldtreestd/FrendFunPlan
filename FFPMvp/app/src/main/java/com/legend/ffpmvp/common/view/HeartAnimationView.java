...
import com.legend.ffpmvp.common.utils.BezierEvaluatorUtils;
...
public class HeartAnimationView extends RelativeLayout {
    ...
    public HeartAnimationView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public HeartAnimationView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        Drawable red = getResources().getDrawable(R.drawable.heart_1);
        Drawable yellow = getResources().getDrawable(R.drawable.heart_2);
        Drawable blue = getResources().getDrawable(R.drawable.heart_3);
