...
public class ReleasePlanPresenter implements CreateContract.ICreatePresenter {

    private CreateContract.ICreateModel model;
    private CreateContract.ICreateView view;

    public ReleasePlanPresenter(CreateContract.ICreateModel model,CreateContract.ICreateView view) {
        this.model = model;
        this.view = view;
    }
    @Override
